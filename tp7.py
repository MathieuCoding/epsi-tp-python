...
driver.find_element(By.XPATH,
                    '//*[@id="page-content"]/ng-component/ng-component/clex-texts-of-law-filters/div/div/div/span').click()
time.sleep(1)
driver.find_element(By.XPATH,
                    '//*[@id="page-content"]/ng-component/ng-component/clex-texts-of-law-filters/div/ul/a/div/label').click()
time.sleep(3)
...
for link in links:
    i = i + 1
    if i > 3:  # for testing purposes only, else up number of articles
        break
    print()
    print("#", i)
    print(link)
...
open("data/data.json", "w", encoding='utf-8').write(json.dumps(json_data,
                                                               indent=4,
                                                               sort_keys=False,
                                                               ensure_ascii=False))